...
define([
    ...
    '../../moduals/modal-returnbillingaccount/model',
    '../../moduals/modal-returnbillingaccount/collection',
    'text!../../moduals/modal-returnbillingaccount/tpl.html',
    ...
    var billaccountView = BaseModalView.extend({
        ...
        bindModalKeys: function () {
            var _self = this;
            this.bindModalKeyEvents(window.PAGE_ID.RETURN_BILLING_ACCOUNT, window.KEYS.Esc , function () {
                _self.hideModal(window.PAGE_ID.BILLING_RETURN);
                $('input[name = billingrt]').focus();
            });
            this.bindModalKeyEvents(window.PAGE_ID.RETURN_BILLING_ACCOUNT, window.KEYS.Enter , function () {
